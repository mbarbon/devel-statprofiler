...
my @traces = map {
  ...
  ($] > 5.038 ? '__FILE__:main;t/lib/Test.pm:t::lib::Test::spawn:226' : 't/lib/Test.pm:main' ) . ';__FILE__:main::__ANON__:20;t/lib/Test.pm:t::lib::Test::take_sample:$TAKE_SAMPLE_LINE;(unknown):Time::HiRes::usleep',
  qw(
